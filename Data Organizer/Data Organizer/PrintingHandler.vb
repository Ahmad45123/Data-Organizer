...
Module PrintingHandler
    ...
    Public Sub Intial(ByVal aDataGridView As DataGridView, ByVal aPrintDocument As PrintDocument, ByVal CenterOnPage As Boolean, ByVal WithTitle As Boolean, ByVal aTitleText As String, ByVal aTitleFont As Font, _
    ...
    Private Sub Calculate(ByVal g As Graphics)
        If PageNumber = 0 Then
            ...
            For i As Integer = 0 To TheDataGridView.Columns.Count - 1
                ...
                RowHeaderHeight = tmpSize.Height + tmpSize.Height
                ...
                For j As Integer = 0 To TheDataGridView.Rows.Count - 1
                    ...
                    RowsHeight.Add(tmpSize.Height + tmpSize.Height)
        ...
        While CurrentRow < TheDataGridView.Rows.Count
            ...
            If TheDataGridView.Rows(CurrentRow).Visible Then
                ...
                For CurrentCell As Integer = CInt(mColumnPoints(mColumnPoint).GetValue(0)) To CInt(mColumnPoints(mColumnPoint).GetValue(1)) - 1
                    ...
                    Dim CellBounds As New RectangleF(CurrentX + 1, CurrentY + 8, ColumnWidth, RowsHeight(CurrentRow))
